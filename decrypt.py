...
pt = fo.read()
fo.close()
pt = ''.join(chr(int(pt[i:i+8], 2)) for i in range(0, len(pt), 8))
...
plain1 = decrypt(key3, pt, 0)
print(plain1)
plain2 = encrypt(key2, plain1, 0)
print(plain2)
finalplain = decrypt(key1, plain2, padding)
print(finalplain)
fo3 = open("outputfile.txt","w")
fo3.write(finalplain)
fo3.close()
